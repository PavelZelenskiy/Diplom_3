...
class TestConstructorPage:
    ...
    @allure.title('Проверка отображения модального окна "Детали ингридиента" по нажатию на элемент: ингридиент')
    @allure.description('Проверка отображения модального окна "Детали ингртдиента" по нажатию на элемент: ингридиент')
    def test_check_modal_ingr_details_is_displayed(self, driver):
    ...
    @allure.title('Проверка закрытия модального окна "Детали ингридиента" по нажатию на элемент: кнопка закрыть')
    @allure.description('Проверка закрытия модального окна "Детали ингртдиента" по нажатию на элемент: кнопка закрыть')
    def test_close_modal_ingr_details(self, driver):
        constructor_page = ConstructorPage(driver)
        constructor_page.wait_for_load_ingridient()
        constructor_page.click_ingridient()
    ...
    def test_check_ingridient_counter(self, driver):
        constructor_page = ConstructorPage(driver)
        constructor_page.wait_for_load_ingridient()
